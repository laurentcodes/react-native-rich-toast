...
const ToastComponent = ({ variant, text1, text2, richColors = true, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: [styles.container, theme.container], children: [(0, jsx_runtime_1.jsx)(react_native_1.Text, { style: [styles.title, theme.title], numberOfLines: 2, ellipsizeMode: 'tail', children: text1 }), text2 && ((0, jsx_runtime_1.jsx)(react_native_1.Text, { style: [styles.message, theme.message], numberOfLines: 2, ellipsizeMode: 'tail', children: text2 }))] }));
};
const createToastVariant = (variant, richColors) => {
    const ToastVariant = (props) => ((0, jsx_runtime_1.jsx)(ToastComponent, { variant: variant, richColors: richColors, ...props }));
...
const StyledToast = ({ topOffset, richColors = false, position = 'top', }) => {
    const toastConfig = (0, exports.createToastConfig)({ richColors });
    return (0, jsx_runtime_1.jsx)(react_native_toast_message_1.default, { config: toastConfig, topOffset: topOffset, position: position });
};
